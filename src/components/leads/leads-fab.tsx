...
export function LeadsFab({ count }: { count: number }) {
  ...
  return (
    <Link
      ...
      className="group fixed bottom-6 right-6 z-40 flex items-center gap-2.5 rounded-full bg-brand-strong px-4 py-3.5 text-white shadow-lg shadow-navy-900/25 transition hover:brightness-110 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-strong"
    >
